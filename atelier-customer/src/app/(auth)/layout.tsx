    ...
    <>
      <header className="top-0 left-0 w-full z-50 h-[100px] flex items-center bg-surface/80 backdrop-blur-sm px-margin-mobile md:px-margin-desktop">
        <div className="max-w-container-max mx-auto w-full flex justify-between items-center">
          <Link className="font-headline-md text-headline-md font-normal tracking-widest text-primary uppercase" href="/">Atelier</Link>
          <Link className="font-label-caps text-label-caps text-on-surface-variant hover:text-primary transition-colors duration-300" href="/">Quay lại</Link>
        </div>
      </header>
